...
describe('Patron Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'patron', component: PatronComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to patronService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPatronIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPatronIdentifier).toHaveBeenCalledWith(entity);
